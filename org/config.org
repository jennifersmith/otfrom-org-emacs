...
*** TODO add back the level 2 max level stuff here
...
** csv-mode
   ...
   csv files.
*** TODO Last run couldnt find csv-mode
...
*** TODO Reinstate any obviously required packages and modes
*** TODO emacs server
*** TODO Shove in some of the stuff in the local/custom.el into here
*** TODO Visual line mode or word wrap configuration?
*** TODO Timestamps with times by default?
*** TODO Better search-in-files from emacs?

*** TODO Get projectile saving somewhere sensible

*** TODO Added back gnu repo - how does that affect a rebuild (was prev trouble with org version)
...
*** TODO org timestamp default to minutes and second?
