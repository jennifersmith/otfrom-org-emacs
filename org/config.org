...
I should put these things somewhere nice...
...
+ Try and consume some of the amazing productivity pr0n stuff @otfrom has in his config ( specially the agenda stuff)
+ Review the packages i did have
+ Remove all packages and recompile and address any warnings
+ emacs server

Fixes/ideas
+ org timestamp default to minutes and second?
+ Dumb-ass mode for things I already looked up… a whereis history?
